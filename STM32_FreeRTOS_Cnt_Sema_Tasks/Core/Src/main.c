...
// Declare variable of type xSemphoreHandle. This is used to reference the semaphore used for sychronization
...
//  SEGGER_UART_init(250000);
  ...
  sprintf(usr_msg,"Demo of counting semaphore /r/n");
  printmsg(usr_msg);
  ...
  {
	 sprintf(usr_msg, "Sema create failed.. \r\n");
	 printmsg(usr_msg);
  }

  //if the control comes here then the launch of the scheduleer has failed due to insufficient memory in
  // the heap
